  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col min-w-0" style={{ backgroundColor: '#f3f4f8' }}>
        ...
        {/* Topbar */}
        <header className="h-14 bg-white flex items-center justify-between px-7 sticky top-0 z-30" style={{ borderBottom: '1px solid #e8eaf0' }}>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              {showNotif && (
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-2xl border z-50 overflow-hidden" style={{ borderColor: '#e8eaf0' }}>
                  ...
                  <div className="max-h-64 overflow-y-auto">
                    {notifications.length === 0 ? (
                      ...
                      <div key={n.id} className={`px-4 py-3 hover:bg-gray-50 transition ${!n.is_read ? 'bg-blue-50/40' : ''}`} style={{ borderBottom: '1px solid #f5f6fa' }}>
            ...
            <button className="flex items-center gap-2 px-3.5 py-2 rounded-xl border text-[13px] text-gray-500 hover:bg-gray-50 transition font-medium" style={{ borderColor: '#e8eaf0' }}>
        ...
        <main className="flex-1 p-8">
          ...
          {loading ? (
            ...
            <div className="text-center py-16 bg-white rounded-2xl border border-dashed" style={{ borderColor: '#d1d5db' }}>
              ...
              {(user?.role === 'admin' || user?.role === 'manager') && (
                <Link to="/projects/new" className="bg-blue-600 text-white text-xs font-semibold px-5 py-2.5 rounded-xl hover:bg-blue-700 transition">
                  Create project
                </Link>
              )}
            </div>
